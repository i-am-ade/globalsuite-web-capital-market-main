...
export default observer(function Page() {
  ...
  <main className="flex min-h-screen flex-col items-center p-5 gap-16">
     <div className="border rounded-xl shadow min-w-full">
     <h4 className="flex justify-start lg:justify-center items-center text-base px-10 w-full capitalize bg-[#194bfb] text-white rounded-t-xl h-10">
            ...
            <Link
              ...
              className={`${pathname === '/user/capital-market/maintain/capital-market-parameters/minimum-buy'} ? bg-gray-40 rounded p-1 : 'text-xs text-neutarl-800 py-0.5 px-1 border rounded'`}
      ...
      <div className="px-5 border m-4 rounded-xl shadow-md">
        <small className="block text-gray-500 my-5 font-bold">Minimum Value (Buy)</small>
      ...
      <div className="px-5 border m-4 rounded-xl shadow-md">
        <small className="block t text-gray-500 my-5 font-bold">Minimum Value (Sale)</small>
