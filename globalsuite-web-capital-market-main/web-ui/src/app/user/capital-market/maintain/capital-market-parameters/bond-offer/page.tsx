  ...
  <main className="flex min-h-screen flex-col items-center p-5 gap-16 bg-gray-50 ">
     ...
     <h4 className="flex justify-start lg:justify-center items-center text-base px-10 w-full capitalize bg-[#194bfb] text-white rounded-t-xl h-10">
            ...
            <Link
              ...
              className={`${pathname === '/user/capital-market/maintain/capital-market-parameters/bond-offer'} ? bg-gray-40 rounded p-1 : 'text-xs text-neutral-800 py-0.5 px-1 border rounded'`}
      ...
      <div className="px-5 border m-10 rounded-xl shadow-md">
        <small className="block text-gray-500 my-3 font-bold">Free Rate</small>
