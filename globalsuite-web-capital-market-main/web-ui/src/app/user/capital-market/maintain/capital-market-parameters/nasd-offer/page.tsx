...
export default observer(function Page() {
  ...
  <main className="flex min-h-screen flex-col items-center p-5 gap-16">
     <div className="border rounded-xl shadow bg-gray-50 w-full">
     <h4 className="flex justify-start lg:justify-center items-center text-base px-10 w-full capitalize bg-[#194bfb] text-white rounded-t-xl h-10">
            <Link
              ...
              className="text-xs text-white py-1 px-2 border rounded"
            >
              General
            </Link>
            <Link
            ...
            <Link
              ...
              className={`${pathname === '/user/capital-market/maintain/capital-market-parameters/nasd-offer'} ? bg-gray-40 rounded p-1 : 'text-xs text-neutral-800 py-0.5 px-1 border rounded'`}
      ...
      <div className="px-5 border m-4 rounded-xl shadow-md">
        <small className="block text-gray-500 my-2 font-bold">Fee Rate</small>
      ...
      <div className="px-5 border m-4 rounded-xl shadow-md">
      <small className="block text-gray-500 my-2 font-bold">Fee GL Accounts</small>
      <div className="grid lg:grid-cols-3 gap-5">
      <div className="col-span-1">
    <span className="block text-base my-2 font-semibold">SEC Fee</span>
            <Select
              defaultValue="009"
              className="w-full"
              options={[
      ...
      <div className="col-span-1">
    <span className="block text-base my-2 font-semibold">NSE Fee</span>
            <Select
              defaultValue="009"
              className="w-full"
              options={[
      ...
      <div className="col-span-1">
    <span className="block text-base my-2 font-semibold">Commission </span>
            <Select
              defaultValue="009"
              className="w-full"
              options={[
    ...
    <span className="block text-base my-2 font-semibold">Contract Stamp</span>
            <Select
              defaultValue="009"
              className="w-full"
              options={[
      ...
      <div className="col-span-1 my-5">
    <span className="block text-base my-2 font-semibold">VAT</span>
            <Select
              defaultValue="009"
              className="w-full"
              options={[
      ...
      <div className="col-span-1 my-5">
    <span className="block text-base my-2 font-semibold">CSCS Fee</span>
            <Select
              defaultValue="009"
              className="w-full"
              options={[
