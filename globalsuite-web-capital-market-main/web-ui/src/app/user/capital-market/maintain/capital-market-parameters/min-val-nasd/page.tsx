      ...
      <main className="flex min-h-screen flex-col items-center p-5 gap-16">
        ...
        <h4 className="flex justify-start lg:justify-center items-center text-base px-10 w-full capitalize bg-[#194bfb] text-white rounded-t-xl h-10">
            ...
            <Link
              ...
              className={`${pathname === '/user/capital-market/maintain/capital-market-parameters/min-val-nasd'} ? bg-gray-40 rounded p-1 : 'text-xs text-neutral-800 py-0.5 px-1 border rounded'`}
          ...
          <div className="px-5 border m-4 rounded-xl shadow-xl">
            ...
            <div className="w-2/5 mx-auto my-3 py-10 flex flex-col justify-center">
              <span className="block my-2 font-semibold text-base">Commission</span>
              <Input placeholder="NOTHING" className="shadow-sm" />
            </div>
            </div>
            <div className="px-5 border m-4 rounded-xl shadow-xl">
