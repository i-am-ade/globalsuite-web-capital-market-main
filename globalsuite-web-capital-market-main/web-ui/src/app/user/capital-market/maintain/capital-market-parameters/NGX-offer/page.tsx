...
export default observer(function Page() {
  ...
  <main className="flex min-h-screen flex-col items-center p-5 gap-16">
     ...
     <h4 className="flex justify-start lg:justify-center items-center text-base lg:px-10 w-full capitalize bg-[#194bfb] text-white rounded-t-xl h-10">
            <Link
            ...
            <Link
              ...
              className={`${pathname === '/user/capital-market/maintain/capital-market-parameters/NGX-offer'} ? bg-gray-40 rounded p-0.5x : 'text-xs text-neutral-800 py-0.5 px-1 border rounded'`}
      ...
      <div className="px-5 border m-3 rounded-xl shadow-md">
      ...
      <div className="col-span-1">
    <span className="block text-base font-semibold my-2">SEC Fee</span>
            <Select
              defaultValue="009"
              className="w-full"
              options={[
    ...
    <span className="block text-base font-semibold my-2">CONTRACT STAMP</span>
            <Select
              defaultValue="009"
              className="w-full"
              options={[
      ...
      <div className="col-span-1 my-5">
    <span className="block text-base font-semibold my-2">VAT</span>
            <Select
              defaultValue="009"
              className="w-full"
              options={[
      ...
      <div className="col-span-1 my-5">
    <span className="block text-base font-semibold my-2">CSCS FEE</span>
            <Select
              defaultValue="009"
              className="w-full"
              options={[
