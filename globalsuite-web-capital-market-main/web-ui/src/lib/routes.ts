...
export const ROUTES = {
  ...
  capitalMarketStockMarketTrading: () => ({
    title: "Capital Market",
    path: "/user/capital-market/stock-market-trading/allotment-deals",
    children: [
      {
        title: "Capital Market",
  ...
  capitalMarketPortfolioManagement: () => ({
    title: "Capital Market",
    path: "/user/capital-market/portfolio-management/Add-To-Portfolio-Holding-Balance",
    children: [
      {
        title: "Capital Market",
        path: "/user/capital-market/portfolio-management/Add-To-Portfolio-Holding-Balance",
        label: "Add To Portfolio Holding Balance",
      },
      {
        title: "Capital Market",
        path: "/user/capital-market/portfolio-management/Add-Or-Deduct-Portfolio-Holding-Balance",
        label: "Add Or Deduct Portfolio Holding Balance",
      },
      {
        title: "Capital Market",
        path: "/user/capital-market/portfolio-management/stock-position-for-seperate-data",
        label: "CSCS Stock Position For Seperate Data",
      },
      {
        title: "Capital Market",
        path: "/user/capital-market/portfolio-management/Send-Customer-Stock-Position-To-Email-Yse-FoxPro-Upload",
        label: "Send Customer Stock Position To Email- Yse FoxPro Upload",
      },
    ],
  }),
  ...
  capitalMarketReport: () => ({
    title: "Capital Market",
    path: "/user/capital-market/report/customer-statement-of-account",
  }),
